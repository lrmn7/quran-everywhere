...
export default function JadwalSolatHariIni() {
  ...
  return (
    <Layout name="Jadwal Sholat">
      <h1 className="text-3xl font-bold text-pink-500 mb-3">Jadwal Sholat</h1>
      ...
      >
        <h2 className="text-lg font-bold text-pink-500">Atur Lokasi</h2>
        ...
        <button
          ...
          className="px-3 py-2 rounded-lg bg-pink-500 text-rose-50"
        >
          Simpan
        </button>
      </div>
        ...
        <>
          {jadwalSholat.date && (
            <>
              ...
              <button
                onClick={() => setDisplayMap(!displayMap)}
                className="px-3 py-2 mt-3 rounded-lg bg-pink-500 text-rose-50"
